...
highchart(type = "map") %>% 
  ...
  hc_title(text = "79 municipios son parte de la cuarta encuesta",
  ...
  hc_chart(backgroundColor="#FFFFFF", style=list(fontFamily = "Roboto Condensed",
                                                 color = "black")) %>% 
  htmlwidgets::saveWidget(here::here("img/semana_4/donde.html")) 
...
ocupacion %>% 
  ...
  write_csv("output/comparacion/ocupacion_s3.csv")
...
ocupacion[[1]] %>% 
  ...
  ggsave("img/semana_4/ocupacion_capitales.jpg", width = 8, height = 8)
...
ocupacion[[3]] %>% 
  ...
  theme(legend.key.height = unit(2.25, "line")) +
  theme(legend.text = element_text(size = 10, hjust = 0, vjust = 0.75)) +
  ggsave("img/semana_4/ocupacion_rurales.jpg", width = 8, height = 8)
...
ocupacion[[2]] %>%
  ...
  theme(legend.key.height = unit(2.25, "line")) +
  theme(legend.text = element_text(size = 10, hjust = 0, vjust = 0.75)) +
  ggsave("img/semana_4/ocupacion_intermedias.jpg", width = 8, height = 8)
...
abastece %>% 
  ...
  write_csv("output/comparacion/abastece_s3.csv")
...
hctreemap2(data = abastece,
  ...
  hc_credits(text = "Los colores y el tamaño de los rectángulos indican la concentración de casos para cada categoría", enabled = TRUE,
              align =  "center", style=list(fontFamily = "Roboto Condensed",
                                            fontSize = 17)) %>% 
  htmlwidgets::saveWidget(here::here("img/semana_4/", "abastecimiento.html"))
...
disponibilidad %>% 
  ...
  ggsave("img/semana_4/disponibilidad.jpg", width = 20, height = 8) 
...
disponibilidad %>% 
  ...
  write_csv("output/comparacion/disponibilidad_s3.csv")
...
escasez_productos %>% 
  ...
  write_csv("output/comparacion/escasez_s3.csv")
...
temp %>% 
  ...
  ggsave("img/semana_4/escasez_capitales.jpg", height = 8, width = 8)
...
temp %>% 
  ...
  theme(legend.text = element_text(size = 14, hjust = 0, vjust = 0.75)) +
  theme(legend.position = "bottom") + 
  ggsave("img/semana_4/escasez_intermedias.jpg", height = 8, width = 8)
...
temp %>% 
  ...
  theme(legend.text = element_text(size = 14, hjust = 0, vjust = 0.75)) +
  theme(legend.position = "bottom") + 
  ggsave("img/semana_4/escasez_rural.jpg", height = 8, width = 8)
...
dificultades %>% 
  ...
  write_csv("output/comparacion/dificultades_s3.csv")
...
hctreemap2(data = dificultades,
  ...
  hc_credits(text = "Los colores y el tamaño de los rectángulos indican la concentración de casos para cada categoría", enabled = TRUE,
             align =  "center", style=list(fontFamily = "Roboto Condensed",
                                           fontSize = 17)) %>% 
  htmlwidgets::saveWidget(here::here("img/semana_4/", "dificultades.html"))
...
abril_15 %>% 
  ...
  ggsave("img/semana_4/abril_15.jpg", width = 20, height = 8) 
...
abril_15 %>% 
  ...
  write_csv("output/comparacion/abril_15_s3.csv")
...
gam %>% 
  ...
  ggsave("img/semana_4/gam.jpg", width = 20, height = 8) 
...
gam %>% 
  ...
  write_csv("output/comparacion/gam_s3.csv")
...
abastece %>% 
  ...
  ggsave(here::here("img/semana_4/treemap_abastecimeinto_ciudades.jpg"), height = 8, width = 12)
...
abastece %>% 
  ...
  ggsave(here::here("img/semana_4/treemap_abastecimeinto_ciudades_intermedias.jpg"), height = 8, width = 12)
...
abastece %>% 
  ...
  ggsave(here::here("img/semana_4/treemap_abastecimeinto_rural.jpg"), height = 8, width = 12)
...
dificultades %>% 
  ...
  ggsave(here::here("img/semana_4/treemap_dificultades_rural.jpg"), height = 8, width = 12)
...
dificultades %>% 
  ...
  ggsave(here::here("img/semana_4/treemap_dificultades_capitales.jpg"), height = 8, width = 12)
...
dificultades %>% 
  ...
  ggsave(here::here("img/semana_4/treemap_dificultades_intermedias.jpg"), height = 8, width = 12)
